...
/// Modern school card specifically for schools list with last visit date
Widget buildSchoolCardWithLastVisit(BuildContext context, String schoolName,
    DateTime? lastVisitDate, String? lastVisitSource, ColorScheme colorScheme,
    {required VoidCallback onTap, Color? color}) {
  AppSizes.init(context);
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            lastVisitDate != null
                                ? '${DateFormat('yyyy/MM/dd', 'ar').format(lastVisitDate)}${lastVisitSource != null ? ' ($lastVisitSource)' : ''}'
                                : 'لم تتم الزيارة',
                            style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w600,
